...
public class Plateau {
    ...
    public Piece placerPiecesAleatoirement(){
        ...
        for(int i=0; i<49; i++){
            ...
            while(this.getPiece(posX, posY) != null) {
                posX = Utils.genererEntier(6);
                posY = Utils.genererEntier(6);
            }
            this.positionnePiece(pieces[i], posX, posY);
        }
        return pieces[49];
    }
