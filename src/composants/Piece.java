...
abstract public class Piece {
    ...
    /**
     * A Faire (12/05/2021 EB Finalisee)
     *
     * Constructeur permettant de créer une pièce d'un modèle avec l'orientation 0.
     * @param modelePiece Le modèle de la pièce.
     * @param pointEntreeHaut Un boolean indiquant si la pièce a un point d'entrée en haut.
     * @param pointEntreeDroite Un boolean indiquant si la pièce a un point d'entrée à droite.
     * @param pointEntreeBas Un boolean indiquant si la pièce a un point d'entrée en bas.
     * @param pointEntreeGauche Un boolean indiquant si la pièce a un point d'entrée à gauche.
     */
    ...
    public void rotation(){
        ...
        // faire mieux avec une boucle (et fonction copy)?
